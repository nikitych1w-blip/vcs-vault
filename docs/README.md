...
Документация по устройству vcs-vault для новых участников команды.
...
| [skills.md](skills.md) | Ролевые скиллы: структура, содержание, как собираются в openspec/config.yaml |
